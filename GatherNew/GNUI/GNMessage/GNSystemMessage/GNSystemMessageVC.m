...
@interface GNSystemMessageVC ()<UITableViewDataSource,UITableViewDelegate,XBTableViewRefreshDelegate>

@property (nonatomic, strong) GNMessageVM *viewModel;

@end

@implementation GNSystemMessageVC
...
- (void)binding {
    ...
    [self.tableView registerNib:[GNSystemMessageTVC nib] forCellReuseIdentifier:kUICellIdentifier];
    [self.tableView addRefreshControl];
    
    self.viewModel = [[GNMessageVM alloc] initWithType:GNMessageTypeSystem];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    GNSystemMessageTVC *cell = [tableView dequeueReusableCellWithIdentifier:kUICellIdentifier forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    GNSystemMessageTVC *cell = (GNSystemMessageTVC *)[tableView cellForRowAtIndexPath:indexPath];
